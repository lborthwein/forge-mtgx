...
public final class HumanManaXSmoke {
    ...
    public static void main(String[] args) {
        ...
        check(0, List.of(ManaCostShard.W), List.of(w, paid));
        check(1, List.of(ManaCostShard.W, ManaCostShard.W), List.of(w, b, paid));
        check(1, List.of(ManaCostShard.W, ManaCostShard.B), List.of(paid, w));
        check(1_000_000, List.of(ManaCostShard.W, ManaCostShard.W), List.of(w, b));
        check(1_000_000, List.of(ManaCostShard.GENERIC, ManaCostShard.GENERIC), List.of(paid));
        check(0, List.of(ManaCostShard.GENERIC, ManaCostShard.W), List.of(paid, b, w));
